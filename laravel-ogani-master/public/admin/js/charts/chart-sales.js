...
!function (NioApp, $) {
  ...
  var salesRevenue = {
    ...
    datasets: [{
      label: "Sales Revenue",
      color: [NioApp.hexRGB("#28a745", .2), NioApp.hexRGB("#28a745", .2), NioApp.hexRGB("#28a745", .2), NioApp.hexRGB("#28a745", .2), NioApp.hexRGB("#28a745", .2), NioApp.hexRGB("#28a745", .2), NioApp.hexRGB("#28a745", .2), NioApp.hexRGB("#28a745", .2), NioApp.hexRGB("#28a745", .2), NioApp.hexRGB("#28a745", .2), NioApp.hexRGB("#28a745", .2), "#28a745"],
  ...
  var activeSubscription = {
    ...
    datasets: [{
      label: "Active User",
      color: [NioApp.hexRGB("#28a745", .2), NioApp.hexRGB("#28a745", .2), NioApp.hexRGB("#28a745", .2), NioApp.hexRGB("#28a745", .2), NioApp.hexRGB("#28a745", .2), "#28a745"],
