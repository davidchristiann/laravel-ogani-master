            ...
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form
                            ...
                            data-stripe-publishable-key="pk_test_51NEW0FAZqqoOqzdmEfWCBAPaLviNAQkY7wQUgtorCa8DauRphhgndUOqiv510wN6NFlXtGgNsM3AQ1OO4JB6P7EE00rdEn3XgQ"
                            id="payment-form">
                        @csrf
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 form-group card required'>
                                <label class='control-label'>Total Amount</label> <input
                                    autocomplete='off' class='form-control card-number' size='20'
                                    type='text' value="{{ $totalPrice }} " disabled>
                            </div>
                        </div>
