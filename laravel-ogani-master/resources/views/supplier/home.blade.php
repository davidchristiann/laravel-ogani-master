                                                    ...
                                                    <div class="card-inner">
                                                        ...
                                                        <div class="data">
                                                            <div class="data-group">
                                                                <div class="amount">{{ $totalOrder }}</div>
                                            ...
                                            <div class="card">
                                                <div class="nk-ecwg nk-ecwg6">
                                                    <div class="card-inner">
                                                        ...
                                                        <div class="data">
                                                            <div class="data-group">
                                                                <div class="amount">Rp.{{ $totalRevenue }}</div>
                                                                <div class="nk-ecwg6-ck">
                                            ...
                                            <div class="card">
                                                <div class="nk-ecwg nk-ecwg6">
                                                    <div class="card-inner">
                                                        <div class="card-title-group">
                                                            <div class="card-title">
                                                                <h6 class="title">Total Product Sales</h6>
                                                            </div>
                                                        </div>
                                                        <div class="data">
                                                            <div class="data-group">
                                            ...
                                            <div class="card">
                                                <div class="nk-ecwg nk-ecwg6">
                                                    <div class="card-inner">
                                                        <div class="card-title-group">
                                                            <div class="card-title">
                                                                <h6 class="title">Total Paid Orders</h6>
                                                            </div>
                                                        </div>
                                                        <div class="data">
                                                            <div class="data-group">
                                                                <div class="amount">{{ $totalCheckout }}</div>
                                                                <div class="nk-ecwg6-ck">
